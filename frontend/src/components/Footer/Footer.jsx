...
export default function Footer() {
  return (
    <div className={s.contenedorFooter}>
      <div className={s.contenedorMenusFooter}>
      ...
      <div className={s.contenedorTerminos}>
        {/* <div className={s.textoTerminos}>
          If you prefer not to receive emails like this, you may{" "}
          <b>unsuscribe.</b>
        </div> */}
        <div
          className={s.textoTerminos}
        >{`(c) 2023 Melinda Muriel. All rights reserved.`}</div>
      </div>
    </div>
  );
}

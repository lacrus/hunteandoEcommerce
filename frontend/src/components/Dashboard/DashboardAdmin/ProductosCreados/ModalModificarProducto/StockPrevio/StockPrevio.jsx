...
import s from "../../../CrearProducto/Stock/Stock.module.css";
      ...
      if (talles.length > 1) {
        if (!talles[talles.length - 1].id) {
          ...
          Swal.fire({
            ...
            text: "Los talles creados previamente solo se pueden modificar",
            icon: "error",
            footer:
              "Si no deseas que aparezca en las busquedas dale cantidad 0",
          });
          console.log("no se elimina porque tiene ID");
        }
      }
    }
  }
